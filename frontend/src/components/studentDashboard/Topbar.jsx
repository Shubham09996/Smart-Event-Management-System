    ...
    >
      <div className="px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        >
          ...
          <p className="text-sm text-slate-500 font-medium italic">Discover and register for exciting campus events</p>
        </motion.div>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="text-right hidden lg:block">
                <p className="text-sm text-slate-900 font-black">{user?.name || "Student User"}</p>
                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">{user?.role || "Student"}</p>
              </div>
